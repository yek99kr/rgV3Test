    ...
    <>
      {slice.variation === "3411" ? (
        ...
        <>
          {slice.primary.media1.link_type === "Web" ? (
            <div
              className={`col-start-3 md:col-start-1 w-[90vw] md:w-[${
                slice.primary.media1Width ? slice.primary.media1Width : "55.9"
              }vw] relative rounded md:place-self-start md:left-[5vw] aspect-square`}
            >
              <iframe
                className="w-[100%] h-[100%]"
                src={`${slice.primary.media1.url.slice(
          ...
          {slice.primary.media2.link_type === "Web" ? (
            <div
              className={`col-start-3 md:col-start-5 w-[70vw] md:w-[${
                slice.primary.media2Width ? slice.primary.media2Width : "31.5"
              }vw] relative rounded md:place-self-end md:right-[${
                slice.primary.media2LeftMargin
                  ? slice.primary.media2LeftMargin
                  : "5"
              }vw] aspect-[9/16]`}
            >
